...
loadSound("ha", "./assets/sounds/ha.mp3")
...
scene("death", (score) => {
	if (music && !music.paused()) music.stop()
	play("ha")
	add([
	...
	add([
		text("press spacebar to play again", 3),
		pos(15, 40),
	]);
...
scene("menu", () => {
	...
	add([
		text('this time its personal', 3),
		pos(35, 40)
	])

	add([
		text("press spacebar to play", 3),
		pos(35, 55),
	]);
